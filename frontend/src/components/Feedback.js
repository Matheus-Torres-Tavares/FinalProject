                ...
                return (
                    <Card className="cardbody" style={{ width: '60rem', height: '10rem' }}>
                        <Card.Body >
                            ...
                            <Button className="votebtn" onClick={() => actions.vote({ type: "feedback", vote: 1, postId: kata._id })}>↑{kata.upVotes.length}</Button>
                            <Button className="votebtn" onClick={() => actions.vote({ type: "feedback", vote: -1, postId: kata._id })}>↓{kata.downVotes.length}</Button>
